...
public class BabyVillagerModel extends VillagerModel {
    ...
    public static MeshDefinition createBodyModel() {
        ...
        PartDefinition nose = head.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(23, 0).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 2.0F, 1.0F), PartPose.offset(0.0F, -2.0F, -4.0F));
        nose.addOrReplaceChild("mole", CubeListBuilder.create(), PartPose.ZERO);
